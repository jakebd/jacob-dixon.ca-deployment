...
async function generateEmbeddings(){
    ...
    const documents = [
        ...
        // "Jacob has a diverse range of hobbies that include photography, cooking, gaming, coding, and running. Each of these activities reflects a different aspect of his interests and skills, from artistic expression and technical proficiency to teamwork and personal fitness.",
