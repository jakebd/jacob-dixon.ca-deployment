    ...
    <article class="resume-wrapper text-center position-relative">
	    <div class="resume-wrapper-inner mx-auto text-start bg-white shadow-lg">
		    <header class="resume-header pt-4 pt-md-0">
              ...
              <?php $img_url = wp_get_attachment_image_url(201, "square");?>
				        <img class="picture" src=<?= $img_url?> alt="A Head shot of the creator, jacob">
				    </div><!--//col-->
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">Jacob Dixon</h1>
							    <div class="title mb-3">Web Developer</div>
							    <ul class="list-unstyled">
								    <li class="mb-2"><a class="text-link" href="#"><i class="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i>Jacob.dixon@live.com</a></li>
								    <li><a class="text-link" href="#"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>902-222-9322</a></li>
							    </ul>
						    </div><!--//primary-info-->
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled">
								    ...
								    <li>
								        ...
								        <div class="resume-degree-org">Dalhousie</div>
								        <div class="resume-degree-time">2017 - 2019</div>
								    </li>
							    </ul>
						    </div>
					    ...
					    <section class="resume-section language-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled resume-lang-list">
								    <li class="mb-2"><span class="resume-lang-name font-weight-bold">English</span> <small class="text-muted font-weight-normal">(Native)</small></li>							    </ul>
						    </div>
